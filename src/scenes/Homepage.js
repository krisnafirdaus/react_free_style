  ...
  const listPricing = [
    {
      price: 27,
      currencySymbol: "$",
      description: "Lorem ipsum us a common text",
      features: [
                ...
                <div className="container-xs">
                  <Fade bottom delay={1000}>
                    <p className="mt-0 mb-32">
                      Our landing page template works in all devices, so you
                      only have to set it up once, and get beautiful result
                      forever.
                    </p>
                  </Fade>
                </div>
              ...
              <div className="section-header center-content">
                <div className="container-xs">
                  ...
                  <p className="m-0">
                    ...
                    the graphic elements of a docoument or visual presentation
                  </p>
                </div>
              </div>
              <div className="tiles-wrap">
